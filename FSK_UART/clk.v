module clk(
	...
	input wire [11:0] clk3_freq,
	input wire [6:0]  clk4_freq,
	output reg clk1,
	output reg clk2,
	output reg clk3,
	output reg clk4
...
reg [17:0] clk3_counter = 0; // 1,56,250
reg [19:0] clk4_counter = 0; // 6,25,000
	...
	always @(posedge clk) begin
		...
		if(clk4_counter == 25000000/(clk4_freq *2)) begin
